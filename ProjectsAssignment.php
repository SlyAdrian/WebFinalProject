...
<?php
  ...
  if(isset($_COOKIE["Cookie"]))
  {
    ...
    if(isset($_POST['ApplyBtn'])){
      ...
      $infoSent = "5" . ";" . "$name" . ";" . "$surname" . ";" . "$counterTotalMembers"; 
  ...
  if(isset($_POST['join']) && $counterV == 0) {
    ...
    $sql = "INSERT INTO 'students' (id, name, surname, subject, team) VALUES ('$counterTotalMembers', '$name', '$surname', '5', '$arrayTeamNumber[1]')";
    $ret = $db->query($sql);
  }
